...
<html>
 <head>
  ...
  <title>Libreria Desarrolla Consultores</title>
 ...
 <body>
  ...
  <div class="container">
   <h1><center>Libreria Desarrolla Consultores</center></h1>
  </center>
  <h3><center>Almacenamiento de libros</center></h3>
  <br />
  <button class="btn btn-success" onclick="add_book()"><i class="glyphicon glyphicon-plus"></i> Agregar Libro a la Biblioteca</button>
  <br />
  <br />
  <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
   <thead>
    <tr>
     ...
     <th style="width:125px;">Acci&oacute;n
      </p></th>
    </tr>
   </thead>
   <tbody>
  ...
  <div class="modal-dialog">
   <div class="modal-content">
    <div class="modal-header">
     ...
     <h3 class="modal-title">Formulario para Libro</h3>
    </div>
     ...
     <form action="#" id="form" class="form-horizontal">
      ...
      <div class="form-body">
       <div class="form-group">
        <label class="control-label col-md-3">ISBN Libro</label>
        <div class="col-md-9">
         <input name="book_isbn" placeholder="Book ISBN" class="form-control" type="text">
        </div>
       </div>
       <div class="form-group">
        <label class="control-label col-md-3">Titulo Libro</label>
        <div class="col-md-9">
         <input name="book_title" placeholder="Book_title" class="form-control" type="text">
        </div>
       </div>
       <div class="form-group">
        <label class="control-label col-md-3">Autor Libro</label>
        <div class="col-md-9">
